...
class __TwigTemplate_ee655db43be40fbd72c687ab4fb21b54 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["menu_name"] ?? null), 24, $this->source))), 2 => "nav", 3 => "navbar-nav", 4 => "navbar-right"];
    ...
    {
        return new Source("", "themes/contrib/bootstrap/templates/menu/menu--account.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/mysite/web/themes/contrib/bootstrap/templates/menu/menu--account.html.twig");
    }
